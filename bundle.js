...
fetch('./players.json').then(function (response) {
...
function makePlayer(player) {
  var WRAPPER = document.querySelector('.players');

  var element = document.createElement('div');
  element.classList.add('player');
  element.style.backgroundImage = 'url("assets/img/players/' + player.name.first + '-' + player.name.last + '.jpeg")';

  var name = document.createElement('span');
  name.classList.add('player__name');
  name.innerText = player.name.last;
